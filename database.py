...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        #Create a dictionary of neos with their designation as the key, to enable fast lookup
        self.neos_dict={}
        for neo in neos:
            self.neos_dict[neo.designation] = neo

        for approach in approaches:
            associated_neo = self.neos_dict.get(approach._designation) #find the corresponding neo object based on its designation
